...
<template>
  <div>
    ...
    >
      <a id="logolink" @click="navigateToDashboard" style="cursor: pointer">
    ...
    <div class="flex flex-col justify-center items-center" style="min-height: calc(100vh - 62px)">
      <div class="flex flex-col justify-center">
        <img src="/demo/images/pages/asset-access.svg" alt="freya-layout" style="width: 332px; height: 271px" />
