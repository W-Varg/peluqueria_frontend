...
<template>
  ...
  <div>
    ...
    <div class="flex flex-col justify-center items-center px-6" style="min-height: calc(100vh - 62px)">
      <div class="flex flex-col justify-center items-center text-center">
        <img src="/demo/images/pages/asset-404.svg" alt="freya-layout" style="margin-bottom: -150px; width: 332px; height: 271px" />
        <span class="" style="font-size: 140px; line-height: 171px">404</span>
        <span class="block text-surface-300 dark:text-surface-500 text-center font-medium">Looks like you are lost.</span>
        <Button type="button" label="Go back to home" size="large" class="mt-6 font-medium" style="" @click="navigateToDashboard"></Button>
      </div>
      <div class="flex flex-wrap align-items-center pt-8 pb-4 px-4">
        <span class="text-2xl font-semibold m-0 mr-5">freya</span>
        <span class="m-0 mt-1 text-300 font-medium">Copyright Ⓒ PrimeTek Informatics</span>
      </div>
    </div>
  </div>
</template>
