<template>
    <form @submit.prevent="saveServicio" class="p-fluid">
        ...
        <div class="field">
            ...
            <Textarea id="descripcion" v-model.trim="servicioLocal.descripcion" required rows="3" :class="{'p-invalid': submitted && !servicioLocal.descripcion}" />
        ...
        <div class="field">
            ...
            <InputNumber id="precio" v-model="servicioLocal.precio" required mode="currency" currency="BOB" locale="es-BO" :min="0" :class="{'p-invalid': submitted && !servicioLocal.precio}" />
