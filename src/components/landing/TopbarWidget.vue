...
<template>
  <div
    :class="
      (menu?.classList.contains('hidden') && menu?.classList.contains('absolute') ? 'hidden ' : 'block md:hidden ') +
      ' absolute z-40 top-0 right-0 w-full h-screen'
    "
    style="background-color: var(--maskbg)"
  ></div>
