<template>
  <div id="pricing" class="landing-section px-6 md:px-20 py-20 mt-20">
    <div
      class="bg-surface-50 dark:bg-surface-950 px-6 py-20 md:px-12 lg:px-20 bg-no-repeat bg-cover bg-gradient-to-b from-primary-50 to-surface-0 dark:from-primary-950 dark:to-surface-900"
    ...
    >
      <div class="flex flex-wrap items-center">
        <div class="w-full lg:w-6/12 lg:pr-20">
          ...
          <h4 class="text-surface-900 dark:text-surface-0 font-normal mb-6 lg:mb-0 leading-normal" style="letter-spacing: 0.6px">
