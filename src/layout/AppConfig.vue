                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex flex-wrap flex-col gap-3">
                            ...
                            <div class="flex">
                                ...
                                <div class="flex items-center gap-2 w-1/2">
                                    <RadioButton name="menuMode" value="slim-plus" v-model="menuMode" @update:modelValue="setMenuMode" inputId="slim-plus"></RadioButton>
                ...
                <div>
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex flex-wrap flex-col gap-4">
                            <div class="flex">
                                <div class="flex items-center gap-2 w-1/2">
                                    <RadioButton name="menuTheme" value="light" v-model="layoutConfig.menuTheme" inputId="light" :disabled="layoutConfig.menuMode === 'horizontal' && isDarkTheme"></RadioButton>
                                    <label for="light">Light</label>
                                </div>
                                <div class="flex items-center gap-2 w-1/2">
                                    <RadioButton name="menuTheme" value="dark" v-model="layoutConfig.menuTheme" inputId="dark" :disabled="layoutConfig.menuMode === 'horizontal' && !isDarkTheme"></RadioButton>
